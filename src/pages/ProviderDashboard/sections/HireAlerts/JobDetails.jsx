import {  Calendar, MapPin, ChevronLeft, Star, MessageCircle, Settings, PhoneCall, Verified, Wrench } from 'lucide-react';
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-xs">{job.providerName}</span>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start  gap-3 border-b border-gray-200">
                ...
                <div>
                  ...
                  <p className="text-sm m mb-3 text-gray-600">₦{job.price.toLocaleString()}</p>
                </div>
              </div>
            </div>
          </div>

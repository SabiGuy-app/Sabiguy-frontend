  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
            ...
            className="px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#8BC53F]"
            >
          <option>Month</option>
          <option>Week</option>
          <option>Year</option>
      ...
      <div className="relative w-full" style={{ height: '256px' }}>
            ...
            <div className="ml-12 h-full flex items-end justify-between gap-1 pb-6" style={{ height: 'calc(100% - 24px)' }}>
            ...
            <div key={index} className="flex-1 flex flex-col items-center relative group h-full justify-end">
              ...
              >
                    {hoveredBar === index && (
                        <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white px-3 py-1.5 rounded text-xs whitespace-nowrap z-10">

...
export default function ProviderCancellationModal({
  isOpen,
  onClose,
  onSubmit,
  onComplete,
    ...
    <>
      ...
      <div className="px-8 pb-6 pt-2 sm:px-9">
          ...
          {REASONS.map((reason) => {
            ...
            return (
              <button
                ...
                className="flex h-[58px] w-full items-center justify-between border-b border-[#231F201A] text-left"
              >
        ...
        <button
          ...
          className="mt-10 flex h-10 w-full items-center justify-center rounded-[4px] bg-[#2F7D4F] text-[14px] font-semibold text-white transition hover:bg-[#286A43] disabled:cursor-not-allowed disabled:bg-[#BFC8C2]"
        >
      ...
      <div className="pb-6">
        ...
        <div className="px-7 sm:px-8">
          <button
            ...
            className="flex h-10 w-full items-center justify-center rounded-[4px] bg-[#2F7D4F] text-[14px] font-semibold text-white transition hover:bg-[#286A43] disabled:cursor-not-allowed disabled:bg-[#BFC8C2]"
          >
            {submitting ? "Submitting..." : "Submit"}
          </button>
        </div>
    ...
    <>
      ...
      <div className="px-8 pb-10 pt-9 text-center sm:px-10">
        <p className="mx-auto max-w-[390px] text-[14px] leading-5 text-[#231F20]">
          We have received your cancellation request. This unpaid booking has
        ...
        <div className="mt-[62px] grid grid-cols-1 gap-4 sm:grid-cols-2">
          <button
            type="button"
            onClick={finishFlow}
            className="flex h-10 items-center justify-center rounded-[4px] border border-[#D9D9D9] bg-white text-[14px] font-semibold text-[#231F20] transition hover:bg-[#F7F7F7]"
          >
            Cancel
          </button>
          <button
            type="button"
            onClick={finishFlow}
            className="flex h-10 items-center justify-center rounded-[4px] bg-[#2F7D4F] text-[14px] font-semibold text-white transition hover:bg-[#286A43]"
          >
            Continue
          </button>
        </div>

...
anytime, anywhere."
  ...
  <Link to="/signup" className="block w-full max-w-md">
    <div className="bg-white border-2 border-gray-400 rounded-xl shadow-lg p-6 transition hover:shadow-xl hover:border-green-600 cursor-pointer text-center">
      ...
      {/* Text */}
      <h2 className="text-xl font-semibold text-gray-800 mb-1">I need a service</h2>
      <p className="text-gray-600 text-lg">Find skilled professionals for your needs.</p>
      <p className="text-gray-600 text-sm">Connect with plumbers, electricians, tutors, tech experts and more.</p>
    </div>
  </Link>

  {/* Card 2 */}
  <Link to="/service-provider/signup" className="block w-full max-w-md">
    <div className="bg-white border-2 border-gray-400 rounded-xl shadow-lg p-6 transition hover:shadow-xl hover:border-[#FF791A] cursor-pointer text-center">
      ...
      {/* Text */}
      <h2 className="text-xl font-semibold text-gray-800 mb-1">I provide a service</h2>
      <p className="text-gray-600 text-lg">Grow your business and find new clients.</p>
      <p className="text-gray-600 text-sm">Showcase your skills and get hired for jobs in your area.</p>
    </div>
  </Link>
</div>
      ...
      {/* Arrow icon that appears on hover */}
       ...
       <Link to="/login">
        <button
          className="text-lg px-4 py-2 font-medium text-[#005823] hover:text-black transition-all duration-200 flex items-center"
        >
          <span>Login</span>

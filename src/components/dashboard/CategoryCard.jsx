...
export default function CategoryCard({ image, title, description, onClick, bgColor }) {
  return (
    <div
      onClick={onClick}
      ...
      <div className="absolute p-4 inset-0 flex flex-col items-start justify-center">
        ...
        <p className="text-sm mt-1 text-white">
          {description}
           ...
           <button className="bg-gray/5 mt-2 text-white rounded-2xl px-2 py-1 text-xs flex items-center gap-1  backdrop-blur-md

...
import {
  ...
  TriangleAlertIcon,
  ArrowLeftIcon,
} from "../dashboard/icons/index";

const AddVehicle = ({ title = "Vehicle" }) => {
  return (
    <div className="w-full flex justify-center mt-15 max-lg:my-10 px-5">
...
const DesktopLayout = ({ title }) => {
  return (
    <>
      <div className="hidden lg:flex justify-center gap-30">
        <div className="">
        ...
        <div className="w-full max-w-[477px] flex flex-col gap-8 justify-center items-center h-full">
          <div className="flex flex-col gap-3 justify-center items-center">
            ...
            <p className="font-normal text-[#231F20BF] text-center">
              Enter your vehicle details carefully. Once submitted, these
          ...
          <div className="flex justify-center items-center bg-[#FFFBEB] border border-[#FDE68A] rounded-lg text-[#991B1BB2] text-sm gap-2 py-3 px-6">
            <TriangleAlertIcon />
    ...
    <>
      <div className="lg:hidden">
        ...
        <div className="w-full max-w-[477px] flex flex-col gap-8 justify-center items-center h-full">
          ...
          <div className="flex items-center bg-[#FFFBEB] border border-[#FDE68A] rounded-lg text-[#991B1BB2] text-sm gap-2 py-3 px-4">
            <TriangleAlertIcon />

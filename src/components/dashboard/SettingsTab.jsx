  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="mb-8 sm:mb-12">
        ...
        <p className="text-xs sm:text-sm text-gray-500 mb-6 sm:mb-8">Choose which update you want to receive via Email</p>
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2">
                <span className="text-xs sm:text-sm text-gray-700 w-14 text-right">Push</span>
                <button
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs sm:text-sm text-gray-700 w-14 text-right">Email</span>
                <button
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="flex-1">
              <h3 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">Job Completed</h3>
              <p className="text-xs sm:text-sm text-gray-600">Notification when the provider marks the job done</p>
            </div>
            <div className="flex flex-col gap-3 sm:gap-3">
              <div className="flex items-center justify-between sm:justify-end gap-2">
                <span className="text-xs sm:text-sm text-gray-700">Push</span>
                <button
                ...
                >
                  <span
                    className={`absolute top-0.5 left-0.5 w-4 sm:w-5 h-4 sm:h-5 bg-white rounded-full transition-transform ${
                      notifications.jobCompletedPush ? "translate-x-5 sm:translate-x-6" : ""
                    }`}
                  />
                </button>
              </div>
              <div className="flex items-center justify-between sm:justify-end gap-2">
                ...
                >
                  <span
                    className={`absolute top-0.5 left-0.5 w-4 sm:w-5 h-4 sm:h-5 bg-white rounded-full transition-transform ${
                      notifications.jobCompletedEmail ? "translate-x-5 sm:translate-x-6" : ""
                    }`}
                  />
                </button>
              </div>
            ...
            <div className="flex flex-col gap-3 sm:gap-3">
              <div className="flex items-center justify-between sm:justify-end gap-2">
                ...
                >
                  <span
                    className={`absolute top-0.5 left-0.5 w-4 sm:w-5 h-4 sm:h-5 bg-white rounded-full transition-transform ${
                      notifications.jobCompleted2Push ? "translate-x-5 sm:translate-x-6" : ""
                    }`}
                  />
                </button>
              </div>
              <div className="flex items-center justify-between sm:justify-end gap-2">
                ...
                >
                  <span
                    className={`absolute top-0.5 left-0.5 w-4 sm:w-5 h-4 sm:h-5 bg-white rounded-full transition-transform ${
                      notifications.jobCompleted2Email ? "translate-x-5 sm:translate-x-6" : ""
                    }`}
                  />
                </button>
              </div>

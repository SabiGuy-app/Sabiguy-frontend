...
// API Integration Guide (commented for reference)
/*
...
// 2. Real-time location tracking with WebSocket
useEffect(() => {
...
<GoogleMap
  center={booking.providerLocation}
  zoom={14}
  mapContainerStyle={{ width: '100%', height: '100%' }}
>
  <Marker position={booking.providerLocation} label="Provider" />
  <Marker position={booking.customerLocation} label="You" />
  <Polyline
    path={[booking.providerLocation, booking.customerLocation]}
    options={{ strokeColor: '#3B82F6', strokeWeight: 4 }}
  />
</GoogleMap>

// 4. Cancel booking API call
const confirmCancel = async () => {
  try {
    await axios.post(`${API_URL}/bookings/${bookingId}/cancel`, {
      reason: cancelReason

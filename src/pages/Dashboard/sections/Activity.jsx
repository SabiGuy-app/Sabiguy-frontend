...
import { Wallet, Clock, CheckCircle, ChevronLeft, ChevronRight, X } from "lucide-react";
...
export default function ActivityPage() {
  ...
  const handleDelete = async (id) => {
    try {
      ...
      throw err; // Re-throw so Activities component can show toast error
    }
  };
  ...
  return (
    <DashboardLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <ActivityCard
          title="Active orders"
          figure={loading ? "..." : String(activeBookings)}
          icon={<Clock size={20} className="text-yellow-500" />}
        />
        <ActivityCard
          title="Completed tasks"
          figure={loading ? "..." : String(completedTasks)}
          icon={<CheckCircle size={20} className="text-green-400" />}
        />
        <ActivityCard
          title="Payments"
          figure={loading ? "..." : String(paymentCount)}
      ...
      */}
      ...
      <div className="space-y-3">
        {loading ? (
          // Skeleton loading — shows 4 placeholder cards
          <>
            <ActivitySkeleton />
            <ActivitySkeleton />
            <ActivitySkeleton />

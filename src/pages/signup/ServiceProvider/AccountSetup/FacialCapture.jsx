...
//         },
//         body: JSON.stringify({ profilePic: data.file.url }),
//       });
...
//       <p className="mb-6 text-gray-600">Please look into the camera and hold still.</p>
...
//               faceDetected
//                 ? "bg-[#005823] hover:bg-[#004419] text-white shadow-lg"
...
//               onClick={handleSave}
//               disabled={uploading}
//               className="px-4 py-2 text-white bg-[#005823] hover:bg-[#004419] rounded-lg"
//             >
